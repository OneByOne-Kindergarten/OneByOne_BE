...
public class KindergartenResponseDTO {
  ...
  public KindergartenResponseDTO(
      ...
      Integer pupilCount4,
      Integer pupilCount5,
      Integer mixPupilCount,
      Integer specialPupilCount,
      Double latitude,
      Double longitude) {
    ...
    this.totalPupilCount =
        pupilCount3 + pupilCount4 + pupilCount5 + mixPupilCount + specialPupilCount;
  ...
  public KindergartenResponseDTO(
      ...
      Integer totalPupilCount,
      KindergartenInternshipReviewAggregateDTO internshipReviewAggregate,
  ...
  public static KindergartenResponseDTO from(Kindergarten kindergarten) {
    int totalClass =
        kindergarten.getClassCount3()
            + kindergarten.getClassCount4()
            + kindergarten.getClassCount5();
    int totalPupil =
        kindergarten.getPupilCount3()
            + kindergarten.getPupilCount4()
            + kindergarten.getPupilCount5()
            + kindergarten.getMixPupilCount()
            + kindergarten.getSpecialPupilCount();
