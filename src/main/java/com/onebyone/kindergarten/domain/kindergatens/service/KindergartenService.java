...
public class KindergartenService {
  ...
  private final KindergartenInternshipReviewAggregateRepository
      kindergartenInternshipReviewAggregateRepository;
      ...
      kindergartenRepository
          ...
          .ifPresentOrElse(
              ...
              () -> {
                ...
                KindergartenInternshipReviewAggregate kindergartenInternshipReviewAggregate =
                    KindergartenInternshipReviewAggregate.builder()
                ...
                kindergartenInternshipReviewAggregateRepository.save(
                    kindergartenInternshipReviewAggregate);
                newKindergarten.updateInternshipReviewAggregate(
                    kindergartenInternshipReviewAggregate);

                KindergartenWorkReviewAggregate kindergartenWorkReviewAggregate =
                    KindergartenWorkReviewAggregate.builder()
  ...
  /// 유치원 검색
  public Page<KindergartenResponseDTO> searchKindergartens(
      KindergartenSearchDTO searchDTO, Pageable pageable) {
    return kindergartenRepository
        .findBySearchCriteria(searchDTO, pageable)
  ...
  public List<KindergartenResponseDTO> getNearbyKindergarten(
    ...
    List<Kindergarten> nearbyKindergartens =
        kindergartenRepository.findNearbyKindergartenEntities(latitude, longitude, radiusKm);
    return nearbyKindergartens.stream().map(KindergartenResponseDTO::from).toList();
  }
