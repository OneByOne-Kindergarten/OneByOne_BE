...
public class CommunityCommentService {
  ...
  public CommentResponseDTO createComment(Long postId, CreateCommentRequestDTO dto, Long userId) {
    ...
    if (dto.getParentId() != null) {
      parent =
          commentRepository
              .findByIdWithUser(dto.getParentId())
    ...
    if (post.getDeletedAt() == null) {
      notificationTemplateService.sendCommentNotification(
          notificationTarget.getId(), user, dto.getContent(), parent != null, postId);
    }
  ...
  public Page<CommentResponseDTO> getAllCommentsWithReplies(
      Long postId, Pageable pageable, Long userId) {
  ...
  public PageCommunityCommentsResponseDTO getWroteMyCommunityComments(
    ...
    Page<CommentResponseDTO> commentsPage =
        commentRepository.findByUserId(userId, pageable).map(CommentResponseDTO::fromEntity);
