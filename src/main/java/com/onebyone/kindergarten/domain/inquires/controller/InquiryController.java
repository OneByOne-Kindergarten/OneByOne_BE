...
public class InquiryController {
  ...
  public ResponseDto<InquiryResponseDTO> createInquiry(
    ...
    return ResponseDto.success(
        inquiryService.createInquiry(dto, Long.valueOf(userDetails.getUsername())));
  }
  ...
  public ResponseDto<InquiryResponseDTO> getInquiry(
    ...
    return ResponseDto.success(
        inquiryService.getInquiry(id, Long.valueOf(userDetails.getUsername())));
  }
  ...
  public PageResponseDTO<InquiryResponseDTO> getMyInquiries(
    ...
    return new PageResponseDTO<>(
        inquiryService.getUserInquiries(Long.valueOf(userDetails.getUsername()), pageable));
  }
  ...
  public PageResponseDTO<InquiryResponseDTO> getAllInquiries(
    ...
    return new PageResponseDTO<>(
        inquiryService.getAllInquiries(Long.valueOf(userDetails.getUsername()), pageable));
  }
  ...
  public PageResponseDTO<InquiryResponseDTO> getInquiriesByStatus(
    ...
    return new PageResponseDTO<>(
        inquiryService.getInquiriesByStatus(
            status, Long.valueOf(userDetails.getUsername()), pageable));
  }
  ...
  public ResponseDto<InquiryResponseDTO> answerInquiry(
      ...
      @AuthenticationPrincipal UserDetails userDetails) {
    return ResponseDto.success(
        inquiryService.answerInquiry(id, dto, Long.valueOf(userDetails.getUsername())));
  }
  ...
  public ResponseDto<InquiryResponseDTO> closeInquiry(
      @PathVariable Long id, @AuthenticationPrincipal UserDetails userDetails) {
    return ResponseDto.success(
        inquiryService.closeInquiry(id, Long.valueOf(userDetails.getUsername())));
  }
}
