...
public interface KindergartenWorkHistoryRepository
    extends JpaRepository<KindergartenWorkHistory, Long> {

  @Query(
      "SELECT new com.onebyone.kindergarten.domain.kindergartenWorkHistories.dto.KindergartenWorkHistoryResponse("
  ...
  @Query(
      "SELECT h FROM kindergarten_work_history h "
