...
public class PushNotificationController {
  ...
  public ResponseDto<List<PushNotificationResponseDTO>> getUserNotifications(
    ...
    List<PushNotificationResponseDTO> notifications =
        pushNotificationService.getUserNotifications(userId);
  ...
  public ResponseDto<List<PushNotificationResponseDTO>> getMyNotifications(
    ...
    List<PushNotificationResponseDTO> notifications =
        pushNotificationService.getUserNotificationByUserDetails(
  ...
  public ResponseDto<List<PushNotificationResponseDTO>> getMyUnreadNotifications(
      @AuthenticationPrincipal UserDetails userDetails) {
    List<PushNotificationResponseDTO> notifications =
        pushNotificationService.getUnreadNotificationsByUserDetails(
            Long.valueOf(userDetails.getUsername()));
    return ResponseDto.success(notifications);
  }
  ...
  @Operation(
      summary = "현재 로그인한 사용자의 읽지 않은 알림 개수 조회",
  ...
  public ResponseDto<Long> getUnreadCount(@AuthenticationPrincipal UserDetails userDetails) {
    long count =
        pushNotificationService.countUnreadNotifications(Long.valueOf(userDetails.getUsername()));
