...
public class PushNotification extends BaseEntity {
  ...
  @Builder.Default private Boolean isRead = false; // 읽음 여부

  @Builder.Default private Boolean isSent = false; // 전송 여부
  ...
  @Builder.Default private Integer groupCount = 1; // 그룹화된 알림 개수
