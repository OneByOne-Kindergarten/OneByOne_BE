...
public class CommunityController {
  ...
  public ResponseDto<CommunityPostResponseDTO> createPost(
    ...
    return ResponseDto.success(
        communityService.createPost(request, Long.valueOf(userDetails.getUsername())));
  }
  ...
  public ResponseDto<CommunityPostResponseDTO> getPost(@PathVariable Long id) {
  ...
  public ResponseDto<CommunityLikeResponseDTO> toggleLike(
    ...
    return ResponseDto.success(
        communityLikeService.toggleLike(postId, Long.valueOf(userDetails.getUsername())));
  }
  ...
  public ResponseDto<CommunityLikeResponseDTO> getLikeStatus(
      @PathVariable Long postId, @AuthenticationPrincipal UserDetails userDetails) {
    return ResponseDto.success(
        communityLikeService.getLikeInfo(postId, Long.valueOf(userDetails.getUsername())));
  }
}
