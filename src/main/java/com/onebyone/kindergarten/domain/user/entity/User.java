...
public class User extends BaseEntity {
  ...
  public boolean hasNotificationEnabled(NotificationSetting setting) {
    return switch (setting) {
      ...
      case COMMUNITY_NOTIFICATIONS ->
          communityNotificationsEnabled == null || communityNotificationsEnabled;
  ...
  public void setNotificationSettings(Set<NotificationSetting> enabledSettings) {
    ...
    this.communityNotificationsEnabled =
        enabledSettings.contains(NotificationSetting.COMMUNITY_NOTIFICATIONS);
    this.eventNotificationsEnabled =
        enabledSettings.contains(NotificationSetting.EVENT_NOTIFICATIONS);
  ...
  public static User registerNaver(
      String email,
      String password,
      String naverProviderId,
      String nickname,
      UserRole role,
      String profileImageUrl) {
    return User.builder()
  ...
  public static User registerApple(
      String email, String password, String appleProviderId, String nickname, UserRole role) {
    return User.builder()
        .email(email)
        .password(password)
