...
public class UserBlockController {
  ...
  public ResponseDto<Void> blockUser(
      @AuthenticationPrincipal UserDetails userDetails, @RequestBody UserBlockRequestDto request) {
    userBlockService.blockUser(
        Long.valueOf(userDetails.getUsername()), request.getTargetUserEmail());
  ...
  public ResponseDto<Void> unblockUser(
      @AuthenticationPrincipal UserDetails userDetails, @PathVariable String targetUserEmail) {
  ...
  public ResponseDto<List<BlockedUserResponseDto>> getBlockedUsers(
    ...
    return ResponseDto.success(
        userBlockService.getBlockedUsers(Long.valueOf(userDetails.getUsername())));
  }
}
