...
public class InternshipReviewDTO {
  ...
  public InternshipReviewDTO(
      Long internshipReviewId,
      Long userId,
      String nickname,
      Long kindergartenId,
      String kindergartenName,
      String oneLineComment,
      String workEnvironmentComment,
      Integer workEnvironmentScore,
      String learningSupportComment,
      Integer learningSupportScore,
      String instructionTeacherComment,
      Integer instructionTeacherScore,
      Integer likeCount,
      Integer shareCount,
